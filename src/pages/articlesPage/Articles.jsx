...
const Articles = () => {
  ...
  //   const storedData = window.localStorage.getItem("articleData");
  //   if (storedData !== null) {
  ...
  //   window.localStorage.setItem("articleData", JSON.stringify(tableData));
  ...
  const handleSubmit = (event) => {
    ...
    //   hasShelfLife: formInput.hasShelfLife,
    //   expDate: formInput.expDate,
    // };

    // Update the tableData state by appending the new item
